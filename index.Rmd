...
=======
source("/Users/ignacymorawski/Documents/SPOTDATA/UpdateGitHub.R")
...
<<<<<<< HEAD
#### 1. Czym najmocniej handluje się na rynku głównym GPW niedzielny test3
=======
#### 1. Czym najmocniej handluje się na rynku głównym GPW sunday test4
>>>>>>> master
...
bp3<-ggplot(data=m4,aes(group=theme,fill=color))+
  ...
  coord_flip(clip="off")+
  geom_text(data=m4,aes(spolka,ratio+sign(ratio)*spread/14,label=label,color=color, family="Publico Text"))+
...
bp3b<-ggplot(data=mc4,aes(group=theme,fill=color))+
  ...
  scale_fill_manual(values = cols)+
  coord_flip(clip="off")+
  geom_text(data=mc4,aes(spolka,ratio+sign(ratio)*spread/14,label=label,color=color, family="Publico Text"))+
  scale_color_manual(values = cols)+
  facet_wrap(~theme,scales="free")+
  theme(strip.background = element_rect(fill="transparent",color="transparent"))+
  theme(strip.text = element_text(size=11, face="bold",color="gray23", family="Publico Text"))+
