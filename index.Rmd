...
bp5<-ggplot(data=stock3,aes(x=time,y=change,group=name))+
  ...
  theme(plot.subtitle = element_text(color = "gray23",size=14,margin=margin(t=0,r=0,b=25,l=0,unit="pt")))+
...
bp<-ggplot(table, aes(area = obroty, fill = color, label=label)) +
  ...
  geom_treemap_text(fontface = "italic", 
    ...
    theme(plot.title = element_text(color = "#EC0108",size=18,face="bold"))+
  theme(plot.subtitle = element_text(color = "gray23",size=14,margin=margin(t=0,r=0,b=25,l=0,unit="pt")))+
  theme(legend.position = "none")+
  theme(plot.background = element_rect(fill="#FBEEE1",color="#FBEEE1"))+
  labs(title="",
